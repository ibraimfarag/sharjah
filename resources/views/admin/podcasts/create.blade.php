...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form class="forms-sample" action="{{ url('admin/podcasts') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body"><h4 class="card-title">English</h4>
                                ...
                                <div class="form-group">
                                    <label>Series</label>
                                    <input required type="text" class="form-control" placeholder="Series" name="series" value="{{ isset($page) ? $page->series : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Country</label>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body"><h4 class="card-title">Arabic</h4>
                                ...
                                <div class="form-group">
                                    <label>Speaker</label>
                                    <input type="text" class="form-control" placeholder="Speaker" name="speaker_ar" value="{{ isset($page) ? $page->speaker_ar : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Series</label>
                                    <input required type="text" class="form-control" placeholder="Series" name="series_ar" value="{{ isset($page) ? $page->series_ar : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Country</label>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" placeholder="" name="audio_file" value="" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="others[apple_url]" value="">
                                </div>
                                <div class="form-group">
                                    <label>Google Podcast</label>
                                    <input type="text" class="form-control" placeholder="" name="others[google_url]" value="">
                                </div>
                                <div class="form-group">
                                    <label>SoundCloud</label>
                                    <input type="text" class="form-control" placeholder="" name="others[soundcloud_url]" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group" style="border-top:3px solid #ccc" >
                                    <br/>
                                    <strong>Podcast Slider Images</strong>
                                    <br/>
                                    <br/>
                                    <div class="row">
                                        <div class="col-md-12" id="file-uploads">
                                            <div class="file-upload card-box">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>First Slide (1000x1000): (Will also serve as thumbnail for "More from this series")</label>
                                                            <input required type="file" class="form-control" name="images[1][square]" placeholder="Upload Image">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <br/>
