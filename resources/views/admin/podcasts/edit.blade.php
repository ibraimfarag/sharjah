...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form class="forms-sample" action="{{ url('admin/podcasts/update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <a target="_blank" href="{{ URL('podcasts/preview/'.$page->id) }}">Click here to preview page</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body"><h4 class="card-title">English</h4>
                                ...
                                <div class="form-group">
                                    <label>Series</label>
                                    <input type="text" class="form-control" placeholder="Series" name="series" value="{{ isset($page) ? $page->series : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Country</label>
                                    <input type="text" class="form-control" placeholder="Country" name="country" value="{{ isset($page) ? $page->country : '' }}">
                                </div>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body"><h4 class="card-title">Arabic</h4>
                                ...
                                <div class="form-group">
                                    <label>Speaker</label>
                                    <input type="text" class="form-control" placeholder="Author" name="speaker_ar" value="{{ isset($page) ? $page->speaker_ar : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Series</label>
                                    <input type="text" class="form-control" placeholder="Publication" name="series_ar" value="{{ isset($page) ? $page->series_ar : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Country</label>
                                    <input type="text" class="form-control" placeholder="Country" name="country_ar" value="{{ isset($page) ? $page->country_ar : '' }}">
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    @if($page->audio_file)
                                        ...
                                        File: <a href="{{ asset('public/'.$page->audio_file) }}">{!! asset('public/'.$page->audio_file) !!}</a>
                                        </span>
                                        <br/>
                                        <br/>
                                    @endif
                                    <input type="file" class="form-control" placeholder="" name="audio_file" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="others[apple_url]" value="{{ $page->links ? $page->links->apple_url : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Google Podcast</label>
                                    <input type="text" class="form-control" placeholder="" name="others[google_url]" value="{{ $page->links ? $page->links->google_url : '' }}">
                                </div>
                                <div class="form-group">
                                    <label>SoundCloud</label>
                                    <input type="text" class="form-control" placeholder="" name="others[soundcloud_url]" value="{{ $page->links ? $page->links->soundcloud_url : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-3">
                                                @if($page->sliders[0]->landscape)
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control" name="uploads[{{$page->sliders[0]->landscape->id}}]" placeholder="Upload Image">
                                                    </div>
                                                @else
                                                    <div class="form-group">
