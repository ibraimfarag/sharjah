        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h3>Add a SAT Tour</h3>
                        </div>
                    </div>
                </div>
            </div>

            <form class="forms-sample" action="{{ url('admin/tours') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="file-upload card-box">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="file" class="form-control" name="mainslide" placeholder="Upload Image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
