...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form class="forms-sample" action="{{ url('admin/tours/update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="form-group" style="border-top:3px solid #ccc">
                                ...
                                <div class="row" id="current-images">
                                    ...
                                    <div class="col-md-3">
                                        @if($page->mainSlider)
                                        <img src="{{ asset('public'.$page->mainSlider->landscape->url) }}" width="100%">
                                        @endif
                                        <br/>
                                        <br/>
                                        <div class="form-group">
                                            <label>Thumbnail and Actual Page Image(1000x1000):</label>
                                ...
                                <div class="form-group" style="border-top:3px solid #ccc">
                                    ...
                                    <div class="row" id="current-images">
                                        ...
                                        @foreach($page->sliders as $slide)
                                            <div class="file-upload" style="width:40%;float:left;">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control" name="images[2][square]" placeholder="Upload Image">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
