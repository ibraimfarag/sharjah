...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form class="forms-sample" action="{{ url('admin/materials') }}" method="post" enctype="multipart/form-data">
                <input type="hidden" value="{!! csrf_token() !!}" name="_token">
                <input type="hidden" value="{{ $isVideo }}" name="is_video">
                <input type="hidden" value="{{ $isOpen }}" name="is_open">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="video_file" value="" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group" style="border-top:3px solid #ccc" >
                                    <br/>
                                    <strong>Post Slider Images</strong>
                                    <br/>
                                    <br/>
                                    <div class="row">
