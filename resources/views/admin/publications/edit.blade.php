...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form class="forms-sample" action="{{ url('admin/publications/update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <a target="_blank" href="{{ URL('publications/preview/'.$page->id) }}">Click here to preview page</a>
                            </div>
                        </div>
                    </div>
                </div>
