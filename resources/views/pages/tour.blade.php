...
<head>
    ...
    <meta itemprop="name" content="SAT Tours || {{ isset($_GET['lang']) ? $post->title_ar : $post->title }}">
    ...
    <meta name="twitter:title" content="SAT Tours || {{ isset($_GET['lang']) ? $post->title_ar : $post->title }}">
    ...
    <!-- Open Graph data -->
    <meta property="og:title" content="SAT Tours || {{ isset($_GET['lang']) ? $post->title_ar : $post->title }}" />
    ...
    <title>Re-materialize || {{ isset($_GET['lang']) ? $post->title_ar : $post->title }}</title>
    <!-- Bootstrap core CSS -->
    ...
    <style>
        ...
        */
        ...
        .owl-carousel-holder .arrows button {
                    ...
                    <div class="breadcrumbs">
                        @if(isset($_GET['lang']))
                            <div class="breadcrumbs ar" style="height: 20px;">
                                ...
                                &gt;
                                <a href="{{ url('pages/programmes/sat-tours?lang=ar') }}" style="color: rgb(0, 0, 0);">حوارات ترينالي الشارقة للعمارة: إعادة تكوين</a>
                            </div>
                        @else
                            <div class="breadcrumbs en" style="height: 20px;">
                                ...
                                &gt;
                                <a href="{{ url('pages/programmes/sat-tours') }}" style="color: rgb(0, 0, 0);">SAT Tours</a>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                @if(!count($page->sliders))
                                    <div class="col-md-12">
                                        <img src="{{ asset('public/'.$page->mainSlider->landscape->url) }}" width="100%" class="featured-img">
                                        <span class="imgcap">
                                            @if(isset($_GET['lang']))
                                                <span dir="rtl" class="float-right">{{ $page->mainSlider->landscape->caption_ar }}</span>
                                            @else
                                                <span class="en float-left">{{ $page->mainSlider->landscape->caption }}</span>
                                            @endif
                                            </span>
                                    </div>
                                @else
                        ...
                        <div class="col-md-3 sideb">
                            @if(count($similar))
                                ...
                                @foreach($similar as $pod)
                                    <a href="{{ url('pages/sat-tours/'.$pod->slug) }}{{ isset($_GET['lang']) ? '?lang=ar' : '' }}">
