...
class Tour extends Model
{
    ...
    public function links(){
        return $this->hasOne('App\Models\TourLink');
    }
    ...
    public function sliders(){
        return $this->hasMany('App\Models\TourImageSlide');
    }
    ...
    {
        return $this->hasMany('App\Models\TourExternalFile');
    }
    ...
    {
        return $this->hasMany('App\Models\TourExternalLink');
    }
    ...
    public function getSlidersAttribute(){
        return $this->sliders()->where('is_main',0)->get();
    }
    ...
    public function getMainSliderAttribute(){
        return $this->sliders()->where('is_main',1)->first();
    }
