...
class PublicationController extends Controller
{
    ...
    public function __construct(Publication $model, PublicationImagesUploader $uploader, PublicationLandscapeImageUploader $luploader, ExternalFileUploader $file_uploader)
    {
        $this->model = $model;
