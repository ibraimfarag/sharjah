...
class MaterialController extends Controller
{
    ...
    public function show(){
        $data = $this->model->where('is_video',0)->get();
    ...
    public function single($slug){
        ...
        $similar = Material::where('active',1)->where('slug','!=',$slug)->inRandomOrder()->limit(4)->get();
    ...
    public function edit($id){
        ...
        return view('admin.materials.edit',compact('page','pageType'));
    }
    ...
    public function create(){
        $isVideo = 0;
        $isOpen = 0;
        return view('admin.materials.create',compact('isVideo','isOpen'));
    }
